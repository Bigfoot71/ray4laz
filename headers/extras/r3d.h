...
#define R3D_FLAG_NONE           0
#define R3D_FLAG_FXAA           (1 << 0)
#define R3D_FLAG_BLIT_LINEAR    (1 << 1)
#define R3D_FLAG_ASPECT_KEEP    (1 << 2)
#define R3D_FLAG_STENCIL_TEST   (1 << 3)
#define R3D_FLAG_DEPTH_PREPASS  (1 << 4)
